...
import Editor, { EDITOR_BACKGROUND_COLOR } from 'docs/src/components/CodeEditor/index'
import { updateForKeys } from 'docs/src/hoc/index'
...
class ComponentExampleEditor extends PureComponent {
  state = {}
...
export default updateForKeys(['error', 'value'])(ComponentExampleEditor)
